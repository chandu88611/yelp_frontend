...
export default function Home() {
  ...
  <section>
    ...
    <div
      ...
      style={{
        background: 'url("../assets/images/banners/banner1.jpg") center center'
      }}
    >
      {" "}
                      ...
                      <div className="cat-img category-svg">
                        ...
                        >
                          ...
                          <g>
                            ...
                            <g>
                              {" "}
                              <path d="M386.455,198.212l-53.811-53.811c-3.253-3.254-8.528-3.255-11.784,0c-3.254,3.253-3.254,8.529,0,11.783l47.92,47.92 l-47.92,47.919c-3.254,3.253-3.254,8.529,0,11.783c1.628,1.628,3.76,2.441,5.892,2.441c2.132,0,4.265-0.814,5.891-2.44 l53.811-53.811C389.709,206.742,389.709,201.466,386.455,198.212z">
                                {" "}
                              </path>{" "}
                            </g>{" "}
                          </g>{" "}
                          <g>
                            ...
                            <g>
                              {" "}
                              <path d="M143.223,204.102l47.919-47.92c3.254-3.253,3.254-8.529,0-11.783c-3.253-3.254-8.529-3.254-11.783,0l-53.811,53.811 c-3.254,3.253-3.254,8.529,0,11.783l53.811,53.811c1.626,1.628,3.759,2.441,5.891,2.441s4.265-0.814,5.891-2.442 c3.254-3.253,3.254-8.529,0-11.783L143.223,204.102z">
                                {" "}
                              </path>{" "}
                            </g>{" "}
                          </g>{" "}
                          <g>
                            ...
                            <g>
                              {" "}
                              <path d="M283.22,118.176c-4.386-1.39-9.07,1.041-10.458,5.427L223.356,279.57c-1.39,4.387,1.04,9.07,5.427,10.46 c0.838,0.266,1.685,0.391,2.519,0.391c3.535,0,6.816-2.269,7.941-5.818l49.404-155.967 C290.037,124.248,287.607,119.565,283.22,118.176z">
                                {" "}
                              </path>{" "}
                            </g>{" "}
                          </g>{" "}
              ...
              <div className="item">
                ...
                <div className="card mb-0 overflow-hidden">
                  ...
                  <div className="item-card2-img">
                    ...
                    <div className="item-card2-icons">
                      {" "}
                      <a href="business.html" className="item-card2-icons-l">
                        <i className="fa fa-cutlery" />
                      </a>{" "}
                      <a
                        href="javascript:void(0)"
                    ...
                    <div className="item-card7-desc">
                      ...
                      <ul className="item-cards7-ic mb-0">
                        ...
                        <li className="mb-md-0">
                          <a href="javascript:void(0)" className="icons">
                            <i className="icon icon-event text-muted me-1" /> 5
                            hours ago
                          </a>
                        </li>{" "}
                        <li className="mb-0">
                          <a href="javascript:void(0)" className="icons">
                            <i className="icon icon-phone text-muted me-1" /> 12
                            654 86596
                          </a>
                        </li>{" "}
                      </ul>{" "}
                  ...
                  <div className="card-body">
                    ...
                    <div className="item-card7-desc">
                      ...
                      <ul className="item-cards7-ic mb-0">
                        ...
                        <li className="mb-md-0">
                          <a href="javascript:void(0)" className="icons">
                            <i className="icon icon-event text-muted me-1" /> 1
                            hours ago
                          </a>
                        </li>{" "}
                        <li className="mb-0">
                          <a href="javascript:void(0)" className="icons">
                            <i className="icon icon-phone text-muted me-1" /> 14
                            675 65430
                          </a>
                        </li>{" "}
                      </ul>{" "}
                  ...
                  <div className="card-body">
                    ...
                    <div className="item-card7-desc">
                      ...
                      <ul className="item-cards7-ic mb-0">
                        ...
                        <li className="mb-md-0">
                          <a href="javascript:void(0)" className="icons">
                            <i className="icon icon-event text-muted me-1" /> 22
                            hours ago
                          </a>
                        </li>{" "}
                        <li className="mb-0">
                  ...
                  <div className="card-body">
                    ...
                    <div className="item-card7-desc">
                      ...
                      <ul className="item-cards7-ic mb-0">
                        ...
                        <li className="mb-md-0">
                          <a href="javascript:void(0)" className="icons">
                            <i className="icon icon-event text-muted me-1" /> 2
                            hours ago
                          </a>
                        </li>{" "}
                        <li className="mb-0">
  ...
  <section>
    ...
    <div
      ...
      style={{
        background: 'url("../assets/images/banners/banner5.jpg") center center'
      }}
    >
      {" "}
          ...
          <div className="row text-center">
            ...
            <div className="col-lg-3 col-md-6">
              ...
              <div className="counter-status status md-lg-0">
                ...
                <h5>Total Listings</h5> <h2 className="counter mb-0">17,846</h2>{" "}
              </div>{" "}
            </div>{" "}
            <div className="col-lg-3 col-md-6">
              {" "}
            ...
            <div className="col-lg-3 col-md-6">
              ...
              <div className="counter-status mb-md-0">
                ...
                <h5> Our Clients</h5> <h2 className="counter mb-0">7,569</h2>{" "}
              </div>{" "}
            </div>{" "}
            <div className="col-lg-3 col-md-6">
              {" "}
              <div className="counter-status status mb-0">
                ...
                <h5>Happy Customers</h5> <h2 className="counter mb-0">7,253</h2>{" "}
              </div>{" "}
            </div>{" "}
          </div>{" "}
        </div>{" "}
