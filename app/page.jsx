  ...
  const slides = [
    {
      ...
      description:
        "Explore the best dining spots and hidden gems in your city.",
    },
    {
      image: "/images/hero/business2.jpg",
      title: "Reliable Car Services At Your Fingertips",
      description: "Find trusted mechanics and car service centers nearby.",
    },
    {
      image: "/images/hero/business3.jpg",
      title: "Pamper Yourself with Top Salons & Spas",
      description: "Book appointments for beauty, grooming, and relaxation.",
    },
    {
      image: "/images/hero/business4.jpg",
      title: "Stay Fit at the Best Gyms Near You",
      description: "Join premium gyms and fitness centers in your area.",
    },
  ];
  ...
  return (
    <>
      <section className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className="absolute top-1/2 left-50 transform -translate-y-1/2 flex flex-col gap-2 items-center">
          {slides.map((_, index) => (
            <button
              key={index}
              onClick={() => setCurrentSlide(index)}
              className="relative w-6 h-15 flex items-center justify-center"
            >
              {/* Background Dot (Tall & Slim) */}
              <div className="w-2 h-full bg-gray-500 rounded-full relative overflow-hidden">
                {/* Progress Fill */}
                {index === currentSlide && (
                  <div
          ...
          {/* Play/Pause Button (Same Size as Dots) */}
          <button
            onClick={() => setIsPlaying(!isPlaying)}
            className="mt-4 w-6 h-6 flex items-center justify-center text-white rounded-full transition hover:bg-gray-300 hover:rounded-lg"
            data-aos="zoom-in"
            data-aos-delay="500"
          >
